...
#We import 10000 windows of data, where each window has size 50. The first 49 values are used for training, in order to predict the 50th value.
...
np.savetxt('gaussprocess_CTE/'+'run_'+run+'.txt',rezmat)
